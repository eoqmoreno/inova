  ...
  <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
      <div class="item active" style="background-image: url(images/slider/1.jpg)">
        <div class="caption">
          <div class="animated jackInTheBox"><center><a href="./"><img class="img-responsive" src="images/logo_mini.png" alt="Inova"></a></center></div>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li style="background-color:rgba(255,255,255,0.2);" class="scroll"><a href="#portfolio">Catálogo</a></li>
